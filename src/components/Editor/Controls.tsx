  ...
  return (
    <SidebarMenu className="gap-2 cursor-pointer">
      <SidebarMenuItem className='pl-2'>
        <SidebarMenuButton isActive={action === ACTIONS.SELECT} onClick={() => { setAction(ACTIONS.SELECT); handleClose(); }}>
          <MousePointer2 style={{marginLeft:"8px"}} /> Select
        </SidebarMenuButton>
      </SidebarMenuItem>
      <SidebarMenuItem>
        <SidebarMenuButton isActive={action === ACTIONS.RECTANGLE} onClick={() => { setAction(ACTIONS.RECTANGLE); handleClose(); }}>
          <Square style={{marginLeft:"8px"}}   /> Rectangle
        </SidebarMenuButton>
      </SidebarMenuItem>
      <SidebarMenuItem>
        <SidebarMenuButton isActive={action === ACTIONS.CIRCLE} onClick={() => { setAction(ACTIONS.CIRCLE); handleClose(); }}>
          <Circle style={{marginLeft:"8px"}} /> Circle
        </SidebarMenuButton>
      </SidebarMenuItem>
      <SidebarMenuItem>
        <SidebarMenuButton isActive={action === ACTIONS.SCRIBBLE} onClick={() => { setAction(ACTIONS.SCRIBBLE); handleClose(); }}>
          <Pencil style={{marginLeft:"8px"}} /> Draw
        </SidebarMenuButton>
      </SidebarMenuItem>
      <SidebarMenuItem>
        <SidebarMenuButton isActive={action === ACTIONS.ARROW} onClick={() => { setAction(ACTIONS.ARROW); handleClose(); }}>
          <MoveRight style={{marginLeft:"8px"}} /> Arrow
        </SidebarMenuButton>
      </SidebarMenuItem>
      <SidebarMenuItem>
        <SidebarMenuButton isActive={action === ACTIONS.TEXT} onClick={() => { setAction(ACTIONS.TEXT); handleClose(); }}>
      ...
      <SidebarMenuItem>
        <SidebarMenuButton onClick={() => { handleExport(); handleClose(); }}>
